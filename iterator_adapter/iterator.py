...
from adapters import CollectionAdapter, CSVAdapter, ObjectAdapter, APIAdapter
...
class ColecaoInstrumentos:
    ...
    @property
    def contador_modificacoes(self):
        return self._numero_modificacoes

    def adicionar_adaptador(self, adaptador: CollectionAdapter):
