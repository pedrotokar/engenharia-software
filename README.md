...
Esse repositório contém minhas anotações e exemplos práticos dos conteúdos 
passados na matéria de Engenharia de Software, oferecida para o 6º período da
graduação em Ciência de Dados e Inteligência Artificial da FGV EMAp.

Os resumos e atividades encontrados no repositório são todos sobre padrões de
projetos. A pasta [`resumos`](resumos/) contém diversos arquivos markdown 
